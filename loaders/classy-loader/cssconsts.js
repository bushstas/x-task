...
const data = {
	...
	mnw: value => g('min-width', a(value)),
	mxw: value => g('max-width', a(value)),
	mnh: value => g('min-height', a(value)),
	mxh: value => g('max-height', a(value)),
	...
	lh: value => g('line-height', a(value)),
	fs: value => g('font-size', a(value)),
